...
import rospy
from servoing_pkg.srv import set_stiffness, set_stiffnessResponse
...
def stiffness_request(req):
    response = set_stiffnessResponse()
...
if __name__ == "__main__":
    ...
    s = rospy.Service('stiffness_service', set_stiffness, stiffness_request)
